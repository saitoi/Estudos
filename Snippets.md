[    
    ...
    {trigger: "it", replacement: "\\textit{$0}", options: "mA"},
    {trigger: "ttt", replacement: "\\texttt{$0}", options: "mA"},
    {trigger: "tup", replacement: "\\textup{$0}", options: "mA"},
    {trigger: "bf", replacement: "\\mathbf{$0}", options: "mA"},
    {trigger: "bbb", replacement: "\\Bbb{$0}", options: "mA"},
    ...
    //Spaces
    {trigger: "qua", replacement: "\\quad $0\ ", options: "mA"},
    {trigger: "qqua", replacement: "\\qquad $0\ ", options: "mA"},
    ...
    {trigger: "\\\\(neq|geq|leq|gg|ll|simm)([0-9]+)", replacement: "\\[[0]] [[1]]", options: "rmA"}, // Insert space after inequality symbols
  ...
  //{trigger: "and", replacement: "\\cap", options: "mA"},
    ...
    {trigger: "mz", replacement: "\\mycolv{$0}", options: "mA"},
    {trigger: "Bmat", replacement: "\\begin{Bmatrix}\n$0\n\\end{Bmatrix}", options: "mA"},
    {trigger: "vmat", replacement: "\\begin{vmatrix}\n$0\n\\end{vmatrix}", options: "mA"},
    {trigger: "Vmat", replacement: "\\begin{Vmatrix}\n$0\n\\end{Vmatrix}", options: "mA"},
    {trigger: "case", replacement: "\\begin{cases}\n$0\n\\end{cases}", options: "mA"},
    {trigger: "align", replacement: "\\begin{align}\n$0\n\\end{align}", options: "mA"},
    { trigger: "fl", replacement: "\\begin{flalign*}\n$0\n\\end{flalign*}",
options: "mA"},
