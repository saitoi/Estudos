...
Se analisarmos bem, a árvore graduada é nada mais que uma [[Estrutura de Dados/Árvores/Árvore Rubro-Negra|árvore rubro-negra]] porém empregando a lógica do posto para identificar os nós da árvore ao oposto de utilizar a coloração.
