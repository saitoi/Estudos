...
> $\textit{Definição.}$ Variação da estrutura de dados de árvore rubro-negra na qual os filhos rubros só podem ser inseridos à esquerda, isto é, caso tenhamos apenas um filho rubro.
