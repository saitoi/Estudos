...
| `limits.h`     | Fornece constantes que representam os limites das variáveis inteiras em um dado sistema.<br> Possui uma seção reservada em [[Código C/Conceitos Gerais/Limites\|Limites]]. |
...
| `climits`               | Fornece constantes que representam os limites das variáveis inteiras em um dado sistema.<br> Possui uma seção reservada em [[Código C++/Limites]]. |
